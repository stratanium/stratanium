...
rm -f src/config/stratanium-config.h
...
rm -rf test_bitcoin.coverage/ stratanium-gtest.coverage/ total.coverage/
...
clean_exe src/stratanium-cli
clean_exe src/strataniumd
clean_exe src/stratanium-gtest
clean_exe src/stratanium-tx
clean_exe src/test/test_stratanium
clean_exe src/test/test_stratanium_fuzzy
...
clean_dep . src/config/stratanium-config.h.in
