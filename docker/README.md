...
official/supported Docker Images found at https://hub.docker.com/r/stratanium/strataniumd/
...
**NOTE: Please update the image description at https://hub.docker.com/r/stratanium/strataniumd-develop/ when changing the above text**