...
from test_framework.test_framework import StrataniumTestFramework
...
class LLMQChainLocksTest(StrataniumTestFramework):
    def set_test_params(self):
        self.set_stratanium_test_params(6, 5, fast_dip3_enforcement=True)
