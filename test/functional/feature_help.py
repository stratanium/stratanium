...
"""Verify that starting strataniumd with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start strataniumd with -h for help text")
        ...
        self.log.info("Start strataniumd with -version for version information")
