Contributing to Stratanium Core
============================

The Stratanium Core project operates an open contributor model where anyone is
...
the pull request affects. Valid areas as:
  ...
  - *Qt* for changes to stratanium-qt
...
[Translation Process](https://github.com/Raptor3um/stratanium/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the Stratanium Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Stratanium
Network Protocol consensus changes.

Whether a pull request is merged into Stratanium Core rests with the project merge
...
Patches that change Stratanium consensus rules are considerably more involved than
...
Where a patch set proposes to change the Stratanium consensus, it must have been
...
The review process is normally fairly responsive on the Stratanium Core repository, however
...
The project leader is the release manager for each Stratanium Core release.
