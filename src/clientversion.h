...
#error Client version information missing: version is not defined by stratanium-config.h or in any other way
#endif
...
/**
 * strataniumd-res.rc includes this file, but it cannot cope with real c++ code.
