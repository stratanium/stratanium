...
//! Interface for the src/evo part of a stratanium node (strataniumd process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/llmq part of a stratanium node (strataniumd process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a stratanium node (strataniumd process).
namespace Smartnode
{
class Sync
{
...
//! Top-level interface for a stratanium node (strataniumd process).
class Node
{
public:
    virtual ~Node() {}
