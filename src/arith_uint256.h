...
#ifndef STRATANIUM_ARITH_UINT256_H
#define STRATANIUM_ARITH_UINT256_H
...
public:
     ...
     *
     * Stratanium only uses this "compact" format for encoding difficulty
...
#endif // STRATANIUM_ARITH_UINT256_H
