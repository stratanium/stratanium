    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = "Usage:\n"
            "  stratanium-qt [command-line options]                     \n";
...
All the Stratanium in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 STRA, 0.01 STRA, 0.1 STRA, 1 STRA and 10 STRA -- sort of like the paper money you use every day.</li> \
