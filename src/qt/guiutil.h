...
/** Utility functions used by the Stratanium Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "stratanium:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load stratanium specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a stratanium specific theme is activated (light/dark).*/
