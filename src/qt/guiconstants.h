...
/* StrataniumGUI -- Size of icons in status bar */
static const int STATUSBAR_ICONSIZE = 18;

/* StrataniumGUI -- Size of button icons e.g. in SendCoinEntry or SignVerifyMessageDialog */
...
#define QAPP_ORG_NAME "Stratanium"
#define QAPP_ORG_DOMAIN "stratanium.com"
#define QAPP_APP_NAME_DEFAULT "Stratanium-Qt"
#define QAPP_APP_NAME_TESTNET "Stratanium-Qt-testnet"
#define QAPP_APP_NAME_DEVNET "Stratanium-Qt-%s"
#define QAPP_APP_NAME_REGTEST "Stratanium-Qt-regtest"
