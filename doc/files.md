...
* stratanium.conf: contains configuration settings for strataniumd or stratanium-qt
* strataniumd.pid: stores the process id of strataniumd while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by strataniumd or stratanium-qt
