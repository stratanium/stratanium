...
This document provides guidelines for internationalization of the Stratanium Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `stratanium_en.ts` remains unchanged.
